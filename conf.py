...
html_context = {
    ...
    "github_repo": "liquid-doc",  # Repo name
    "github_user": "vita-dounai",
...
latex_documents = [
    (master_doc, 'Liquid.tex', u'Liquid Documentation',
     u'liquid-dev', 'manual'),
]
...
man_pages = [
    (master_doc, 'Liquid', u'Liquid Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Liquid', u'Liquid Documentation',
     author, 'liquid-dev', 'documents of Liquid',
     'Miscellaneous'),
]
